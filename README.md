...
It archives:    
![An image of the SQLite database schema](./SQLite_schemas.png)
...
There are tests covering all of the helper module, and some classe, the coverage as reported by `coverage` is `69%`, to run the tests run:  
